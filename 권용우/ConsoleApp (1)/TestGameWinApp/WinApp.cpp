...
constexpr int SCREEN_HEIGHT = 1080;//768;

// chatgpt 피셜
// Windows 응용 프로그램에서 윈도우를 화면 중앙에 배치하는 함수를 정의한 것입니다. 이 함수는 주어진 윈도우 핸들(window)을 화면 중앙에 위치시킴.
...
void WinApp::Initialize(HINSTANCE hInstance)
{
	...
	const TCHAR* appName = TEXT("Error: Null Reference");
