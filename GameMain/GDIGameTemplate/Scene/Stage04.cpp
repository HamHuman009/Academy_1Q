...
void Stage04::Init()
{
	...
	UIButton* b_Plus = new UIButton({ 250, 300 }, bg_Plus, L"UI_Button_Pause_VolumeDown", L".png");
	UIButton* b_Minus = new UIButton({ 400, 300 }, bg_Minus, L"UI_Button_Pause_VolumeUp", L".png");
	UIButton* e_Plus = new UIButton({ 250, 500 }, eft_Plus, L"UI_Button_Pause_VolumeDown", L".png");
	...
	Gdiplus::Bitmap* bossFishTarget = CRM->LoadBitmapResouce(L"BossFish4_Objective", L"ScoreBoard_Objective_04.png");
	Gdiplus::Bitmap* bossFishTargetGray = CRM->LoadBitmapResouce(L"BossFish4_ObjectiveBW", L"ScoreBoard_ObjectiveBW_04.png");
