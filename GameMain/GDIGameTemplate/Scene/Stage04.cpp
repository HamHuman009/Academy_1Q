...
void Stage04::Init()
{
	...
	UITimer* myTimer = new UITimer(CRM, Vector2{ 353, 14 }, e_nextScn, 50.0f/*40.f*/);
	...
	myFish = new Fish(L"BossFish", 75.f, 8.7f, L"BossFish_04_Anim_00.png", CRM, L".png", 2.f, 4.f, 30.f, 30.f);
	AddObject(myFish);
	colliderManager->PushCollider(myFish->m_collider, TYPE::FISH);
	//****************배경앞*******************
