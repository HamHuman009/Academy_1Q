...
void Stage04::Init()
{
	...
	SelectScnEvent* e_nextScn = new SelectScnEvent((int)SceneType::STAGE_05);
	AddEvent(e_nextScn);
	...
	AddObject(myFish);
	myFish = new Fish(L"BossFish", 60.f, 8.7f, L"BossFish_04_Anim_00.png", CRM, L".png", 2.f, 4.f, 60.f, 60.f);
	AddObject(myFish);
	//***************************************
	AddObject(m_Player);
