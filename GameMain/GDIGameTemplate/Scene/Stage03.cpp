...
void Stage03::Init()
{
	...
	UITimer* myTimer = new UITimer(CRM, Vector2{ 353, 14 }, e_nextScn, 50.f/*40.f*/);
	...
	m_Player->SetMoveDirection({ -1.f, 0.f }, { 1.f, 0.f }, { 0.f, -1.f }, { 0.f, 1.f });
	...
	Gdiplus::Bitmap* bossFishTarget = CRM->LoadBitmapResouce(L"BossFish3_Objective", L"ScoreBoard_Objective_03.png");
	Gdiplus::Bitmap* bossFishTargetGray = CRM->LoadBitmapResouce(L"BossFish3_ObjectiveBW", L"ScoreBoard_ObjectiveBW_03.png");
	...
	myFish = new Fish(L"BossFish", 75.f, 8.7f, L"BossFish_03_Anim_00.png", CRM, L".png", 2.f, 4.f, 30.f, 30.f);
	AddObject(myFish);
	colliderManager->PushCollider(myFish->m_collider, TYPE::FISH);
	//****************배경앞*******************
